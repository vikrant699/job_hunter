...
export const ProviderSchema = z.enum([
  ...
  "juspay", "amplelogic", "talview", "skuad", "gullak", "ongig", "directemployers", "procmart", "superops", "bmw", "ubs", "reliancebrands", "ralphlauren", "paramai", "spire2grow", "bajajauto", "ujjivan", "consider", "custom",
]);
